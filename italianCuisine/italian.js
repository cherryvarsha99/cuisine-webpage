...
class Pasta extends HTMLElement {
    connectedCallback() {
      this.innerHTML = "<span style='color: red;'> Pasta  is a type of food typically made from an unleavened dough of wheat flour mixed with water or eggs, and formed into sheets or other shapes, then cooked by boiling or baking.<span>";
    }
  }
